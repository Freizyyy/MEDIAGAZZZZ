...
export const VK_SERVICE_KEY = 'ca53c01cca53c01cca53c01cffc96d7188cca53ca53c01ca3d21ffbfdef112253c26cd2';
export const VK_DOMAIN = 'lyceumreview';
...
export const Icons = {
  ...
  Loading: () => (
    <svg className="animate-spin h-5 h-5 text-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
  ),
  // Add missing Chat icon
  Chat: () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/></svg>
  ),
  // Add missing Send icon
  Send: () => (
